...
class DataLoader:
    ...
    def get_batch(self):
        ...
        for each_data in self.data[start_index: end_index]:
            ...
            batch_data["num_char_ids"].append(each_data.num_char_ids)
            batch_data["number_mask"].append(each_data.number_mask)
            batch_data["num_char_mask"].append(each_data.num_char_mask)
